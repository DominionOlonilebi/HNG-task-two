...
<div className="cart-page">
  ...
  {cartProds.map(cartProd => (
    <tr key={cartProd.id}>
      ...
      <td>
        <p className="mb-0 mt-4">{cartProd.Name}</p>
      </td>
      <td>
        <p className="mb-0 mt-4">{cartProd.Price}</p>
      </td>
      <td>
        <div
        ...
        >
          <div className="input-group-btn">
            <button
              onClick={() => decreaseQty(cartProd.id, cartProd.quantity)}
...
<FaMinus/>
          ...
          <div className="input-group-btn">
            <button
              onClick={() => increaseQty(cartProd.id, cartProd.quantity)}
              className="btn btn-sm  "
            >
              <FaPlus/>
            </button>
      ...
      <td>
        <p className="mb-0 mt-4">$ {cartProd.totalPrice} </p>
      </td>
      <td>
        <button
                ...
                <div className="bg-light rounded">
                  <div className="p-4">
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <div>
                        <p className="mb-0">Flat rate: $ {deliveryCharge} </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    type="button"
                  >
                   <Link to="/checkout" className='proceed text-white'>Proceed Checkout</Link> 
                  </button>
                </div>
              </div>
            </div>
